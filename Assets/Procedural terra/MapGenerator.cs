...
public class MapGenerator : MonoBehaviour {
	...
	void OnValidate() {
		if(terrainData != null)
		{	
			terrainData.OnValuesUpdata -= OnValuesUpdata;
			terrainData.OnValuesUpdata += OnValuesUpdata;
		}
		if(noiseData != null)
		{
			noiseData.OnValuesUpdata -= OnValuesUpdata;
			noiseData.OnValuesUpdata += OnValuesUpdata;
		}
		if(texData != null)
		{
			texData.OnValuesUpdata -= onTextureValuesUpdata;
			texData.OnValuesUpdata += onTextureValuesUpdata;
		}
	}
